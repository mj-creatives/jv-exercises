...
export default ({
  ...
  description = "Here are what some of our amazing users are saying about their experience with CoEx Fitness and the variety of tools and knowledge it can provide.",
  testimonials = null,
  textOnLeft = false
}) => {
  /*
  ...
  const defaultTestimonials = [
    {
      ...
      quote:
        "I had a weekly appointment with my trainer at my local gym but needed some more information and understanding on what i was doing. When i found CoEx Fitness i discovered vast information on muscle groups, excercises, and much much more.",
      customerName: "Charlotte Hale",
      customerTitle: "CoEx Fitness User"
    },
    {
      imageSrc:
        testimonial2,
